...
where:
$$
J_2 \approx 1.08263 \times 10^{-3} \text{ (Earth's oblateness coefficient)}
$$ 

$$
R_E = 6378 \text{km (Earth's equatorial radius)}
$$ 

$$
(x, y, z) \text{ (position components)}
$$

$$
\text{and } r = \sqrt{x^2 + y^2 + z^2}
$$
