...
![Deep Learning Concept Map](/images/Projects/The-great-deep-learning-tree.jpeg)

Here's the PDF version: [Download PDF]({{ base_path }}/files/The-Great-Deep-Learning-Tree.pdf)

<object data="{{ base_path }}/files/The-Great-Deep-Learning-Tree.pdf" type="application/pdf" width="100%" height="800px">
  <p>Your browser doesn't support embedded PDFs. <a href="{{ base_path }}/files/The-Great-Deep-Learning-Tree.pdf">Download the PDF</a> instead.</p>
</object>
...
* [GitHub Repository](https://github.com/nicolehao34/Deep-Learning-Roadmap)
* [Concept Map (LucidSpark)](https://lucid.app/lucidspark/2be65c50-6460-499c-b564-ac9ffa4e52e5/edit?viewport_loc=-3962%2C2691%2C1643%2C1027%2C0_0&invitationId=inv_54d3ccbc-df2a-4d0d-89c3-20064abbd922)
